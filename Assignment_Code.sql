...
SELECT "------------------------";
SELECT "Query h: The user names of all users who rated higher than ";
--Your answer here

SELECT "------------------------";
SELECT "Query i: The user names of all users whose number of sad reviews is greater than their reading goal";
--Your answer here
